  ...
  checkFlagCaptures() {
    ...
    this.redTeam.forEach(agent => {
      ...
      if (!agent.hasFlag && 
        ...
        console.log(`Agent ${agent.id} captured blue flag`);
      }
      ...
      if (agent.hasFlag && agent.x <= 1) {
        ...
        this.redScore += 1;
        flagCaptured = true;
        console.log(`Red team scored! New score: ${this.redScore}`);
      }
    });
    ...
    this.blueTeam.forEach(agent => {
      ...
      if (!agent.hasFlag && 
        ...
        console.log(`Agent ${agent.id} captured red flag`);
      }
      ...
      if (agent.hasFlag && agent.x >= this.gridSize - 2) {
        ...
        this.blueScore += 1;
        flagCaptured = true;
        console.log(`Blue team scored! New score: ${this.blueScore}`);
      }
    });
